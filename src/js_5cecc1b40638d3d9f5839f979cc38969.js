...
;
Drupal.locale = { 'strings': { "Unspecified error": "Belgisiz hata", "Select all rows in this table": "Bu tablodaki tüm satırları seç", "Deselect all rows in this table": "Bu satırdaki tüm satırları seçmeyi bırak", "An HTTP error @status occurred. \n@uri": "Bir HTTP hatası çıqtı @status. @uri\r\n", "An error occurred. \n@uri\n@text": "Bir hata çıqtı. @uri @text", "An error occurred. \n@uri\n(no information available).": "Bir hata çıqtı. @uri (malümat yoq). ", "Upload": "Yükleme" } };;
